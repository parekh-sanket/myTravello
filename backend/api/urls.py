...
urlpatterns = [
    ...
    path('get-destination-group/', views.destinationGroup,name="get-destination-group"),
    path('get-destination-list/', views.destinationList,name="get-destination-list"),
    path('get-destination/<int:id>/', views.destination, name="get-destination"),
    
    path('check-date/', views.date_checking, name="date-checking"),
    
    path('payment/',views.payment_checking, name="payment-checking"),
